...
import { ArrowDown, ArrowRight, ArrowUp, CalendarDays, Info, MapPin, Wallet } from "lucide-react";
						...
						<div className="sm:col-span-2 space-y-4">
							...
							<div className="bg-slate-50 dark:bg-slate-900/50 p-6 rounded-2xl border border-slate-100 dark:border-slate-800">
								...
								{interpretation.map((p) => (
									<p
										key={generateKey(p.substring(0, 10))}
										className="text-base sm:text-lg leading-relaxed text-slate-700 dark:text-slate-300 mb-4"
									>
										{p}
									</p>
								))}
