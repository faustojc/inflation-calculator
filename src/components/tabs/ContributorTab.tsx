...
const ContributorTab = (props: { contributors: ContributionFactor[] }) => {
	...
	const [chartType, setChartType] = createSignal<"table" | "pie">("table");

	const personal = () => props.contributors[0]!;
	const comparisons = () => props.contributors.slice(1);

	return (
		<div class="glass-card p-4 space-y-4">
			<div>
				<h3 class="font-bold uppercase tracking-wide text-sm sm:text-base text-foreground">
			...
			<div class="flex flex-wrap items-center justify-between md:justify-start gap-2 md:gap-4">
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-1 border-t border-border pt-3">
				<div class="space-y-1">
					<p class="text-base font-bold text-primary uppercase tracking-wider">% Weight</p>
				...
				<div class="space-y-1">
					<p class="text-base font-bold text-primary uppercase tracking-wider">Inflation Rate</p>
					<p class="text-sm text-muted-foreground leading-snug">
						The year-on-year price change for the commodity group. A positive rate means prices increased; a
						negative rate means they decreased.
					</p>
				</div>
				<div class="space-y-1">
					<p class="text-base font-bold text-primary uppercase tracking-wider">%Share to Inflation</p>
					<p class="text-sm text-muted-foreground leading-snug">
