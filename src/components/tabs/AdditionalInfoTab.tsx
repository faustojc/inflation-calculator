	...
	return (
		<div className="space-y-3">
			...
			<div className="glass-card p-6">
				<div className="flex items-center gap-2 mb-3">
					<Info className="h-4 w-4 text-primary" />
					<h3 className="font-bold uppercase tracking-wide text-base sm:text-2xl">Leave a Feedback</h3>
				</div>

				<p>
					If you have any suggestions, comments, or encounter any issues while using this calculator, please fill out
					the form bellow.
				</p>
